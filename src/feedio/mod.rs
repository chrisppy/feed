...
impl FeedWriter {
    ...
    pub fn new(channel: Channel) -> FeedWriter {
        ...
        if channel.generator().is_some() {
            ...
            let generator_tag = Element::new(description_tag_str);
        ...
        if channel.docs().is_some() {
            ...
            let docs_tag = Element::new(description_tag_str);
        ...
        if channel.language().is_some() {
            ...
            let language_tag = Element::new(description_tag_str);
        ...
        if channel.copyright().is_some() {
            ...
            let copyright_tag = Element::new(description_tag_str);
        ...
        if channel.managing_editor().is_some() {
            ...
            let managing_editor_tag = Element::new(description_tag_str);
        ...
        if channel.web_master().is_some() {
            ...
            let web_master_tag = Element::new(description_tag_str);
        ...
        if channel.pub_date().is_some() {
            ...
            let pub_date_tag = Element::new(description_tag_str);
        ...
        if channel.last_build_date().is_some() {
            ...
            let last_build_date_tag = Element::new(description_tag_str);
        ...
        if channel.ttl().is_some() {
            let ttl_tag_str = "ttl";
            let ttl_tag = Element::new(description_tag_str);
